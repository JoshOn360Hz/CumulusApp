...
struct SplashScreenView: View {
    ...
    private var windSpeedUnitView: some View {
        VStack {
            Spacer()
            ...
            VStack(spacing: 24) {
                VStack(spacing: 8) {
                    ...
                    Text("Choose your preferred wind speed unit")
                        .font(.body)
                        .foregroundColor(.secondary)
                        .multilineTextAlignment(.center)
                }
                ...
                VStack(spacing: 12) {
                    temperatureButton(label: "km/h", icon: "wind", isSelected: windSpeedUnit == "kmh") {
                        windSpeedUnit = "kmh"
                    }

                    temperatureButton(label: "mph", icon: "wind", isSelected: windSpeedUnit == "mph") {
                        windSpeedUnit = "mph"
                    }
                    
                    temperatureButton(label: "m/s", icon: "wind", isSelected: windSpeedUnit == "ms") {
                        windSpeedUnit = "ms"
                    }
                    
                    temperatureButton(label: "Beaufort (Bft)", icon: "wind", isSelected: windSpeedUnit == "beaufort") {
                    ...
                    LazyVGrid(columns: [GridItem(.adaptive(minimum: 90), spacing: 20)], spacing: 25) {
                        ForEach(AppIconManager.iconOptions, id: \.filename) { option in
                            Button {
                                ...
                                AppIconManager.changeAppIcon(to: option.filename)
                            } label: {
                                VStack(spacing: 8) {
