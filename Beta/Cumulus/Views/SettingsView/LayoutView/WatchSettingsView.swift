...
struct WatchSettingsView: View {
    ...
    // Available card types for watch (excluding large cards that wouldn't fit well)
        ...
        NavigationView {
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    Button("Save") {
                        saveWatchSettings()
                        // Don't dismiss immediately - the saveWatchSettings function 
                        // will handle showing the alert and dismissing afterward
                    }
            ...
            .alert("Settings Saved", isPresented: $showConnectionAlert) {
                ...
                if !watchManager.isWatchPaired {
                    ...
                    Text("Your selection has been saved and will sync with your Apple Watch when it becomes available.")
                } else {
                    Text("Your selection has been saved and synced with your Apple Watch.")
                }
            }
        }
        .onAppear {
    ...
    private func saveWatchSettings() {
        ...
        // Always show the connection alert for feedback
        showConnectionAlert = true
        
        // Schedule dismissal after the alert is shown
        // This gives the user time to read the message
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.1) {
            // This will allow the alert to be presented before scheduling dismissal
...
// Extension to add descriptions for cards
